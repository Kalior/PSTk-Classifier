...
class Tree {
 ...
 public:
   ...
   * \return integer
   */
  int getFixedOrder() const { return treeMod_->getOrder(); }
 ...
 protected:
   ...
   */
  void insertWord(Node *, const string &,
                  string &);  //, int  );//, const bool& = true );
   ...
   */
  void checkNumberTokens(StringTokenizer &, const int &, const string &,
                         const int &);
