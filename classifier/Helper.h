...
void DisplayHelp(const string &progName) {
  cout
      ...
      << TreeFactory::toHelp() << FileHandler::toHelp() << "\nExamples:\n"
      << "./classifier -crr -f_f my_list_of_species.txt -ipf .fna -ipwd "
         "data_folder -opwd profiles -osf 16_ -pseudo -npar 16 -minc 15 -kmax "
         "7 -frac 0.1 -s 333 -nofna\n"
      << "---/\n"
      << "./classifier -sap -s 333 -f_f my_list_of_species.txt -ipf .tree "
         "-ipwd profiles -isf m2_ -seq profiles/m2_mySequences.fna -nsamp 100 "
         "-l 35 -m 0 -revcomp\n"
      << "---/\n";
}
