...
const string OP_ILL_VAL[3] = {"Warning: Option: ", ", had an illegal value: \'",
                              "\'. Ignored\n"};
const string OP_NO_VAL[2] = {"Warning: Option: ",
                             ", didn't have a value. Ignored\n"};
const string OP_UNKN[2] = {"Warning: Unknown option: \'", "\'\n"};
const string NO_PARAM_SECTION[2] = {"Warning: No \'",
                                    "\' section in XML file\n"};
const string SETPARAM_FAIL[2] = {"Warning: Failed to set the parameter \'",
                                 "\'. Nonexistant.\n"};
const string NO_DOM_DOCUMENT =
    "Warning: GetXMLParameters cannot extract from "
    "an empty document. Nothing done\n";
const string UNKNOWN_PARAM[2] = {
    "Error: A GetXXParam function was called with "
    "an unknown parameter argument, \'",
    "\'\n"};
const string PARAM_NOT_FOUND[2] = {"Warning: GetParamListSize: Parameter \'",
                                   "\' not found.\n"};
const string VALIDATION_OOB =
    "Warning: Could not validate parameter, out-of-bounds.\n";
const string ACCESS_ERROR_BOOL =
    "Error: GetBoolParam used to get a non-boolean parameter.\n";
const string ACCESS_ERROR_DOUBLE =
    "Error: GetDoubleParam used to get a non-double parameter.\n";
const string ACCESS_ERROR_INT =
    "Error: GetIntParam used to get a non-integer parameter.\n";
const string ACCESS_ERROR_STRING =
    "Error: GetStringParam used to get a non-string parameter.\n";
const string ACCESS_OUT_OF_BOUNDS[2] = {"Error: Trying to access parameter \'",
                                        "\' out-of-bounds.\n"};
const string CHANGE_NOT_ALLOWED[2] = {
    "Warning: Parameter \'", "\' is not allowed to be changed. Ignored.\n"};
