 ...
 * File options <br>
 * { "-f"      ,  "-file"                      , "xxx"             ,
 * PARAM_STRING  , PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-f_f"    ,
 * "-file_of_filenames"         , "xxx"             , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-off"     ,
 * "-output_fasta_file"        , "xxx"             , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-opf"     ,
 * "-output_post_fix"          , ""                , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-ipf"     ,
 * "-input_post_fix"           , ""                , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-osf"     ,
 * "-output_pre_fix"           , ""                , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-isf"     ,
 * "-input_pre_fix"            , ""                , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-opwd"     ,
 * "-output_file_path"        , ""                , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br> { "-ipwd"    ,
 * "-input_file_path"          , ""                , PARAM_STRING  ,
 * PARAM_NORMAL, "", PARAM_TRUE, PARAM_TRUE },<br>
 *
 */
class FileHandler {
